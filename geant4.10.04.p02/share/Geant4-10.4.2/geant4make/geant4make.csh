...
setenv G4LIB "`cd $geant4make_root/../../../lib64/Geant4-10.4.2 > /dev/null ; pwd`"
...
setenv G4LEDATA "`cd $geant4make_root/../data/G4EMLOW7.3 > /dev/null ; pwd`"
setenv G4LEVELGAMMADATA "`cd $geant4make_root/../data/PhotonEvaporation5.2 > /dev/null ; pwd`"
setenv G4RADIOACTIVEDATA "`cd $geant4make_root/../data/RadioactiveDecay5.2 > /dev/null ; pwd`"
