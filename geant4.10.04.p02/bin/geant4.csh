...
#-----------------------------------------------------------------------
# C shell environment setup script for Geant4 10.4.2
#
...
# Resource file paths
# - Datasets
setenv G4NEUTRONHPDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/G4NDL4.5 > /dev/null ; pwd`"
setenv G4LEDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/G4EMLOW7.3 > /dev/null ; pwd`"
setenv G4LEVELGAMMADATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/PhotonEvaporation5.2 > /dev/null ; pwd`"
setenv G4RADIOACTIVEDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/RadioactiveDecay5.2 > /dev/null ; pwd`"
setenv G4NEUTRONXSDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/G4NEUTRONXS1.4 > /dev/null ; pwd`"
setenv G4PIIDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/G4PII1.3 > /dev/null ; pwd`"
setenv G4REALSURFACEDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/RealSurface2.1.1 > /dev/null ; pwd`"
setenv G4SAIDXSDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/G4SAIDDATA1.1 > /dev/null ; pwd`"
setenv G4ABLADATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/G4ABLA3.1 > /dev/null ; pwd`"
setenv G4ENSDFSTATEDATA "`cd $geant4_envbindir/../share/Geant4-10.4.2/data/G4ENSDFSTATE2.2 > /dev/null ; pwd`"
